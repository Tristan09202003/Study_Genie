...
@section('title', 'Adaptive Mock Exams – StudyGenie AI')
    ...
    <style>
        ...
        *::after {
        ...
        .result-card {
            ...
            border-radius: 24px;
            padding: 2rem;
            box-shadow: 0 12px 40px rgba(225, 29, 72, 0.06);
        }
        ...
        .how-section {
            padding: 90px 6%;
            background: linear-gradient(135deg, rgba(225, 29, 72, 0.04) 0%, rgba(190, 18, 60, 0.06) 100%), var(--off);
        }
        ...
        .step:hover {
            border-color: var(--rose);
            box-shadow: 0 16px 50px rgba(225, 29, 72, 0.1);
        }
...
@section('content')
    ...
    <section class="hero">
        <div class="hero-left">
            ...
            <p class="hero-sub">Adaptive mock exams that increase in difficulty as you perform — simulating real exam
                pressure so you're always prepared for the toughest questions.</p>
        ...
        <div class="exam-mock reveal">
            ...
            <div class="exam-body">
                ...
                <div class="exam-q">During oxidative phosphorylation, the proton gradient drives ATP synthesis via which
                    mechanism?</div>
                <div class="exam-opts">
    ...
    <section class="results-section">
        <div class="results-text">
            ...
            <p>After every mock exam, StudyGenie gives you a detailed breakdown — topic by topic — so you can go straight to
                what matters instead of re-reading everything.</p>
        </div>
        <div class="result-card reveal">
            ...
            <div class="rc-breakdown">
                <div class="rcb-row">
                    ...
                    <div class="rcb-bar">
                        <div class="rcb-fill" style="width:95%"></div>
                    </div>
                ...
                <div class="rcb-row">
                    ...
                    <div class="rcb-bar">
                        <div class="rcb-fill" style="width:80%"></div>
                    </div>
                ...
                <div class="rcb-row">
                    ...
                    <div class="rcb-bar">
                        <div class="rcb-fill" style="width:62%"></div>
                    </div>
                ...
                <div class="rcb-row">
                    ...
                    <div class="rcb-bar">
                        <div class="rcb-fill" style="width:44%"></div>
                    </div>
