...
@section('title', 'Voice-Over Tutor Mode – StudyGenie AI')
    ...
    <style>
        ...
        *::after {
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 10px 32px rgba(67, 56, 202, 0.45);
        }
        ...
        .wc1 {
            background: var(--indigo-l);
            border: 1.5px solid var(--indigo-m);
        }
        ...
        .how-section {
            padding: 90px 6%;
            background: linear-gradient(135deg, rgba(67, 56, 202, 0.04) 0%, rgba(55, 48, 163, 0.06) 100%), var(--off);
        }
        ...
        .step:hover {
            ...
            box-shadow: 0 16px 50px rgba(67, 56, 202, 0.1);
        }
...
@section('content')
    ...
    <section class="hero">
        ...
        <p class="hero-sub">An AI voice that explains complex topics in clear, conversational language — so you can learn
            while commuting, exercising, or anytime a screen isn't possible.</p>
    ...
    <div class="player-section">
        <div class="audio-player">
            ...
            <div class="ap-transcript">
                "Think of the <span class="highlight">mitochondria</span> as a tiny power station inside your cell. Its job
                is to take in fuel — like glucose — and convert it into a form of energy your body can actually use, called
                <span class="highlight">ATP</span>. This happens in three main stages: glycolysis, the Krebs cycle, and
                finally oxidative phosphorylation..."
            </div>
    ...
    <section class="features-strip">
        ...
        <div class="fs-grid">
            <div class="fs-card reveal">
                <div class="fs-icon">🔊</div>
                <div>
                    <h4>Natural AI Voice</h4>
                    <p>No robotic TTS — warm, conversational explanations</p>
                </div>
            </div>
            <div class="fs-card reveal">
                <div class="fs-icon">⏩</div>
                <div>
                    ...
                    <p>0.75x to 2x playback — learn at your pace</p>
                </div>
            </div>
            <div class="fs-card reveal">
                <div class="fs-icon">📖</div>
                <div>
                    ...
                    <p>Follow along with highlighted text as it plays</p>
                </div>
            </div>
            <div class="fs-card reveal">
                <div class="fs-icon">🔖</div>
                <div>
                    <h4>Bookmarks</h4>
                    <p>Mark key moments and revisit them instantly</p>
                </div>
            </div>
            <div class="fs-card reveal">
                <div class="fs-icon">📴</div>
                <div>
                    <h4>Offline Mode</h4>
                    <p>Download explanations and listen without internet</p>
                </div>
            </div>
            <div class="fs-card reveal">
                <div class="fs-icon">🎧</div>
                <div>
                    <h4>Earphone Optimized</h4>
                    <p>Balanced, clear audio designed for headphone use</p>
                </div>
            </div>
        </div>
    </section>
