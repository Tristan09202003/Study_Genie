...
<link href="https://fonts.googleapis.com/css2?family=Instrument+Sans:wght@300;400;500;600;700&family=Bricolage+Grotesque:wght@400;600;700;800&display=swap" rel="stylesheet">
...
.notif-dot.rest { background: var(--border); }
...
.feature-cell:hover { background: var(--teal-l); }
.feature-cell:hover .fc-num { color: var(--teal); }
.fc-num {
  font-family: var(--serif);
  font-size: 2rem;
  color: var(--border);
...
.cal-d:hover { background: var(--border-l); }

.cal-d.outside { color: var(--muted-l); pointer-events: none; }
...
.cal-d.session:hover { background: var(--ink-2); }
...
.sched-bar.intense { background: var(--teal); }
.sched-bar.mid { background: var(--teal-pale); }
.sched-bar.light { background: var(--border); }
.sched-label {
  font-size: 0.72rem;
  color: var(--muted-l);
  min-width: 36px;
...
.leg-session { background: var(--ink); }
.leg-today { background: var(--teal-l); border: 1px solid var(--teal); }
.leg-rest { background: var(--white); border: 1px solid var(--border); }
.legend-item span {
  font-size: 0.75rem;
  color: var(--muted);
}
...
.cta-left .label { color: rgba(255,255,255,0.35); }
.cta-left .label::before { background: rgba(255,255,255,0.2); }
...
.btn-primary    { animation-delay: 0.22s; }
.hero-stats     { animation-delay: 0.28s; }
.notif-panel    { animation: fadeUp 0.7s 0.35s ease both; }
...
@media (max-width: 1024px) {
  .hero, .cta-section { grid-template-columns: 1fr; gap: 3rem; }
...
<section class="hero">
  <div class="hero-left">
    ...
    <p class="hero-sub">Intelligent reminders that adapt to your rhythm — not the other way around. StudyGenie learns when you focus best and keeps you on track, effortlessly.</p>
    <a class="btn-primary">
      Get Started
    </a>
    </div>
  ...
  <div class="notif-panel">
    ...
    <div class="notif-accent">
      ...
      <div class="accent-bar"><div class="accent-fill"></div></div>
    </div>
  </div>
</section>
    ...
    <div class="how-list">
      <div class="how-item reveal">
        ...
        <div class="how-body">
          ...
          <p>Tell StudyGenie your available windows, subjects, and learning goals. It takes under two minutes.</p>
        </div>
      </div>
      <div class="how-item reveal">
        ...
        <div class="how-body">
          ...
          <p>The model monitors your response patterns — when you open notifications, when you study longest — and shifts reminder timing to match your natural peaks.</p>
        </div>
      </div>
      <div class="how-item reveal">
        ...
        <div class="how-body">
          ...
          <p>Review prompts are timed to the forgetting curve, so each notification arrives at exactly the right moment for maximum retention.</p>
        </div>
      </div>
      <div class="how-item reveal">
        ...
        <div class="how-body">
          ...
          <p>Streaks, progress charts, and consistency scores give you tangible proof that the system is working.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-wrap">
  <div class="section-header reveal">
    ...
    <p>Every session logged, every streak visible. The calendar updates in real time as you complete study blocks.</p>
  </div>
  ...
  <div class="calendar-grid reveal">
    <div class="calendar-main">
      ...
      <div class="cal-body">
        ...
        <div class="cal-d session"><span class="cal-d-num">2</span><div class="session-bar"></div></div>
        <div class="cal-d session"><span class="cal-d-num">3</span><div class="session-bar"></div></div>
        <div class="cal-d"><span class="cal-d-num">4</span></div>
        <div class="cal-d session"><span class="cal-d-num">5</span><div class="session-bar"></div></div>
        <div class="cal-d session"><span class="cal-d-num">6</span><div class="session-bar"></div></div>
        <div class="cal-d"><span class="cal-d-num">7</span></div>
        <div class="cal-d session"><span class="cal-d-num">8</span><div class="session-bar"></div></div>
    ...
    <div class="cal-sidebar">
      <div class="sidebar-card">
        ...
        <div class="sc-track"><div class="sc-fill" style="width:36%"></div></div>
      ...
      <div class="sidebar-card">
        ...
        <div class="sc-track"><div class="sc-fill" style="width:72%"></div></div>
...
<section class="cta-section">
  ...
  <div class="cta-right reveal">
    ...
    <div class="cta-feature">
      <div class="cta-check">✓</div>
      <p><strong>Set up in under 2 minutes</strong>Import your subjects, choose your notification style, and go.</p>
    </div>
    <div class="cta-feature">
      <div class="cta-check">✓</div>
