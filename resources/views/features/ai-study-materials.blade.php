...
*, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero h1 {
      ...
      font-weight: 800; letter-spacing: -2px; line-height: 1.1; margin-bottom: 1.2rem;
    }
    .hero h1 span { color: var(--blue); }
    .hero-sub { font-size: 1.05rem; color: var(--muted); line-height: 1.75; margin-bottom: 2rem; max-width: 460px; }
    .btn-primary {
    ...
    .hero-visual {
      ...
      border-radius: 24px; padding: 2rem; box-shadow: 0 20px 60px rgba(59,130,246,0.1);
      animation: floatUp 0.8s 0.2s ease both;
    }
    .upload-zone {
      border: 2px dashed var(--blue-m); border-radius: 16px;
      padding: 2rem; text-align: center; background: var(--blue-l);
      margin-bottom: 1.5rem;
    }
    .upload-icon { font-size: 2.5rem; margin-bottom: 0.5rem; }
    .upload-zone p { font-size: 0.85rem; color: var(--blue); font-weight: 500; }
    .upload-zone small { color: var(--muted); font-size: 0.75rem; }
    .result-preview { display: flex; flex-direction: column; gap: 0.7rem; }
    .result-line {
    ...
    .result-line span { font-size: 0.82rem; color: var(--text); font-weight: 500; }
    .result-line .line-bar {
      margin-left: auto; height: 4px; border-radius: 2px; background: var(--blue-l);
    }

    /* WHAT IT DOES */
    .what-section {
      padding: 90px 6%; background: var(--off);
      display: grid; grid-template-columns: 1fr 1fr; gap: 5rem; align-items: center;
    }
    .what-text h2 {
      font-family: 'Bricolage Grotesque', sans-serif;
    ...
    .what-text h2 span { color: var(--blue); }
    .what-text p { color: var(--muted); line-height: 1.8; font-size: 0.95rem; margin-bottom: 1.5rem; }
    ...
    .what-card:hover { border-color: var(--blue); box-shadow: 0 8px 24px rgba(59,130,246,0.08); }
    .wc-icon { 
      width: 44px; height: 44px;
      border-radius: 12px;
      background: var(--blue-l);
      display: flex; align-items: center; justify-content: center;
      font-size: 1.5rem; flex-shrink: 0; margin-top: 0;
      color: var(--blue);
    }
    .what-card h4 { font-family: 'Bricolage Grotesque', sans-serif; font-size: 0.95rem; font-weight: 700; margin-bottom: 0.3rem; }
    .what-card p { font-size: 0.85rem; color: var(--muted); line-height: 1.6; margin: 0; }
    ...
    .formats-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 1.2rem; }
    .format-card {
      background: var(--off); border: 1.5px solid var(--border);
    ...
    .format-card .icon-box { margin-bottom: 1rem; }
    ...
    .how-section .sec-label { font-size: 0.75rem; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; color: var(--blue); margin-bottom: 0.8rem; }
    ...
    .step:hover { border-color: var(--blue); box-shadow: 0 16px 50px rgba(59,130,246,0.1); }
    .step-num {
    ...
    .btn-white { background: #fff; color: var(--blue); border: none; border-radius: 12px; padding: 0.95rem 2.5rem; font-size: 1rem; font-family: 'Instrument Sans', sans-serif; font-weight: 700; cursor: pointer; transition: transform 0.2s, box-shadow 0.2s; box-shadow: 0 6px 24px rgba(0,0,0,0.15); }
    ...
    @media (max-width: 900px) {
      .hero, .what-section { grid-template-columns: 1fr; gap: 3rem; }
...
<section class="hero">
  <div class="hero-left">
    ...
    <p class="hero-sub">Upload any content and let StudyGenie's AI engine instantly create structured summaries, outlines, and key points — so you can focus entirely on learning.</p>
    <a href="/signup" class="btn-primary">Try It Free →</a>
  </div>
  <div class="hero-visual reveal">
    <div class="upload-zone">
      <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" style="margin: 0 auto 1rem; color: var(--blue);">
...
<section class="what-section">
  <div class="what-text">
    ...
    <p>Stop wasting hours reorganizing lectures and textbooks into usable notes. StudyGenie's AI processes your raw content and produces clean, study-ready materials in seconds.</p>
  </div>
  <div class="what-cards">
    ...
    <div class="what-card reveal">
      <div class="wc-icon">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"/><path d="M9 7h6M9 11h6M9 15h4"/>
        </svg>
      </div>
      <div>
    ...
    <div class="what-card reveal">
      <div class="wc-icon">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <circle cx="6" cy="5" r="3"/><circle cx="18" cy="5" r="3"/><path d="M9 7H6a2 2 0 0 0-2 2v2h14v-2a2 2 0 0 0-3-2h-3"/><line x1="9" y1="12" x2="15" y2="12"/><path d="M9 12L6 20a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2l-3-8"/>
        </svg>
      </div>
      <div>
